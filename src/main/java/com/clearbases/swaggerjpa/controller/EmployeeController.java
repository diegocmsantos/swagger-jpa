package com.clearbases.swaggerjpa.controller;

import com.clearbases.swaggerjpa.exception.ResourceNotFoundException;
import com.clearbases.swaggerjpa.model.Employee;
import com.clearbases.swaggerjpa.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getEmployeeById(
        ...
        Employee employee = getEmployeeByIdInner(employeeId);
    ...
    private Employee getEmployeeByIdInner(Long employeeId) throws ResourceNotFoundException {
